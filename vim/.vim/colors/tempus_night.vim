...
hi Search gui=underline,bold,italic guibg=#52ba40 guifg=#1a1a1a cterm=underline,bold ctermbg=2 ctermfg=0
hi IncSearch gui=underline,bold,italic guibg=#c4bdaf guifg=#1a1a1a term=none cterm=underline,bold ctermbg=7 ctermfg=0
