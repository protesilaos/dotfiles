...
*** TODO The =prot-emacs-email.el= basic settings (including =authinfo=)
:PROPERTIES:
...
though I do keep this in place for other programs to read from. CONTINUE.
...
*** TODO The =prot-emacs-email.el= message composition and encryption settings
:PROPERTIES:
...
*** TODO The =prot-emacs-email.el= integration with Dired for email attachments (~gnus-dired-mode~)
:PROPERTIES:
:CUSTOM_ID: h:deccd4f1-c1bd-4b02-993e-914f57ea0fac
:END:

([[#h:f8b08a77-f3a8-42fa-b1a9-f940348889c3][The =prot-emacs-dired.el= module]]).
