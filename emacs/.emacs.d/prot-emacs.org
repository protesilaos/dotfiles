...
*** TODO The =prot-emacs-essentials.el= section about ~tmr~ (set timers)
...
*** TODO The =prot-emacs-essentials.el= section about ~password-store~
:PROPERTIES:
...
*** TODO The =prot-emacs-essentials.el= section about ~shell~
:PROPERTIES:
...
*** TODO The =prot-emacs-essentials.el= section about the laptop battery
:PROPERTIES:
...
*** TODO The =prot-emacs-essentials.el= section about ~exec-path-from-shell~
:PROPERTIES:
