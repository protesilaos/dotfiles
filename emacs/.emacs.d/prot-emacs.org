...
*** TODO The =prot-emacs-git.el= section about =vc.el= and related
:PROPERTIES:
...
*** TODO The =prot-emacs-git.el= section about ~magit~ (great Git client)
:PROPERTIES:
...
*** TODO The =prot-emacs-langs.el= settings for TAB
:PROPERTIES:
...
*** TODO The =prot-emacs-langs.el= settings for "electric" behaviour
:PROPERTIES:
...
*** TODO The =prot-emacs-langs.el= settings ~show-paren-mode~
:PROPERTIES:
...
*** TODO The =prot-emacs-langs.el= settings for plain text
:PROPERTIES:
...
*** TODO The =prot-emacs-langs.el= settings for ~eldoc~
:PROPERTIES:
...
*** TODO The =prot-emacs-langs.el= settings for ~eglot~
:PROPERTIES:
...
*** TODO The =prot-emacs-langs.el= settings for very long lines
:PROPERTIES:
...
*** TODO The =prot-emacs-langs.el= settings for ~markdown-mode~
:PROPERTIES:
...
*** TODO The =prot-emacs-langs.el= settings for ~sxhkdrc-mode~
:PROPERTIES:
...
*** TODO The =prot-emacs-langs.el= settings for spell checking
:PROPERTIES:
...
*** TODO The =prot-emacs-langs.el= settings for ~outline-minor-mode~
:PROPERTIES:
...
*** TODO The =prot-emacs-langs.el= settings for ~altcaps~ (alternating letter casing)
:PROPERTIES:
