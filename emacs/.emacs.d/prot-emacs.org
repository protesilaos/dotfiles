...
*** TODO The =prot-emacs-search.el= setup for editable grep buffers (~wgrep~)
:PROPERTIES:
...
multiple files using Emacs' panoply of editing capabilities. Both of
the variables I configure here have situational usage. I cannot
remember the last time I benefited from them.
