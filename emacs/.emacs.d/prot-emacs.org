...
*** TODO The =prot-emacs-completion.el= section to configure completion annotations (~marginalia~)
:PROPERTIES:
...
*** TODO The =prot-emacs-completion.el= setting to load a minibuffer UI submodule
:PROPERTIES:
