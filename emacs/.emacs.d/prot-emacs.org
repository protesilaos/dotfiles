...
The commands I use the most from this package are ~consult-outline~,
especially in Org buffers, and ~consult-imenu~ in Elisp files. The
rest have situational uses.
