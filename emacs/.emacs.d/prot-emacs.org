...
*** The =prot-emacs-langs.el= settings for plain text
:PROPERTIES:
...
# TODO 2024-01-09 07:10 +0200: mention attachments. ([[#h:deccd4f1-c1bd-4b02-993e-914f57ea0fac][The =prot-emacs-email.el= integration with Dired for email attachments (~gnus-dired-mode~)]])
...
composition buffer ([[#h:f8b08a77-f3a8-42fa-b1a9-f940348889c3][The =prot-emacs-dired.el= module]]). This also works
without an open message composition buffer. In that case, it produces
such a buffer, with the attachments in plce. Though I usually have the
message buffer in place before going to ~dired~ to find some
attachments ([[#h:49815c07-737f-4f10-95ee-63640f9ae18b][The =prot-emacs-email.el= message composition and encryption settings (=message.el=)]]).
...
*** TODO The =prot-emacs-email.el= settings for ~sendmail~
:PROPERTIES:
...
*** TODO The =prot-emacs-email.el= loading of the email client and call to ~provide~
:PROPERTIES:
