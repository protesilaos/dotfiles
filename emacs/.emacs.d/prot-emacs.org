...
handled by the active theme). I arrange to make them narrow and to
keep them around by default. If I was building Emacs with support for
a graphical toolkit, then I would probably disable the scroll bars. At
any rate, when I am enabling scroll bars, I want them to not show up
in the minibuffer, hence ~prot-emacs-no-minibuffer-scroll-bar~.
