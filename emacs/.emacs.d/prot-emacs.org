...
handled by the active theme). I then arrange to make them narrow and
to keep them around by default. Otherwise, I hide them. This is what
the check for ~x-toolkit-scroll-bars~ does.
